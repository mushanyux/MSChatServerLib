...
import (
	...
	"github.com/mushanyux/MSChatServerLib/pkg/msevent"
	"github.com/mushanyux/MSChatServerLib/pkg/mshttp"
	"github.com/mushanyux/MSChatServerLib/pkg/pool"
...
// 认证中间件
func (c *Context) AuthMiddleware(r *mshttp.MSHttp) mshttp.HandlerFunc {
...
// EventBegin 开启事件
func (c *Context) EventBegin(data *msevent.Data, tx *dbr.Tx) (int64, error) {
...
func (c *Context) GetHttpRoute() *mshttp.MSHttp {
	return c.httpRouter
}

func (c *Context) SetHttpRoute(r *mshttp.MSHttp) {
	c.httpRouter = r
}
...
type OnlineStatus struct {
	...
	Online           bool   // 是否在线
	SocketID         int64  // 当前设备在mushanim中的在线/离线的socketID
